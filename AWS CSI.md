...
3. Issues `AWS.DetachVolume` and marks the detached device name as free  (more on that below).

TODO: this has complicated idempotency expectations. It cancels previously called `ControllerPublishVolume` (i.e.AWS is still attaching the volume and Kubernetes now wants the volume to be detached).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0Nzc5MzM5MSwyMDI1NDM0ODQ1XX0=
-->