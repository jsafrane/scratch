...
* CSI `ControllerUnpublishVolume` call (~ volume detach) requires the Secrets to be available at detach time. Current CSI attacher implementation simply expects that the Secrets are available. Secrets for PVs are "global", out of user's namespace, so this assumption is OK.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwMzQ5ODE2MywtMTg2NzgzNDQyOSwtNz
Y5MjcyNzQ2LDMyNDYxNDU2Myw3NzgyODAwNjUsODMzNzM1ODAy
LDY1NTc3MTgxMywtNTE2NzA2NjUwXX0=
-->