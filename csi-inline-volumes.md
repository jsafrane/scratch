...
* CSI `ControllerUnpublishVolume` call (=~ volume detach) needs the Secrets at detach time. Existing volume plugins implemented two approa
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk4MTUxODY1MiwtNzY5MjcyNzQ2LDMyND
